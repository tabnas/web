...
The compiler rewrites direct (`P = P a / b`) and indirect left recursion
into iterative rules. See the [left-recursion elimination algorithm](https://en.wikipedia.org/wiki/Left_recursion#Removing_all_left_recursion).
For example:
