...
<CodeTabs id="docs-plugins-jsonic" label="Start from jsonic" />
...
<CodeTabs id="docs-plugins-expr" label="Layer on the expression plugin" />
...
<CodeTabs id="docs-plugins-parens" label="Parentheses too" />
...
<CodeTabs id="docs-plugins-evaluate" label="A short recursive walk" />

And that's the language:

<CodeTabs id="docs-plugins-config" label="And that's the language" />
