...
export const PACKAGES: {
  ...
  // The engine.
  { name: "parser", tier: "engine", version: "0.7.0", npm: true, go: true,
    blurb: "The engine — a pluggable, rule-based parsing machine and a uniform syntax tree." },

  // Grammar authoring and inspection.
  { name: "abnf", tier: "tooling", version: "0.4.0", npm: true, go: true,
    blurb: "Compile RFC 5234 ABNF straight into a working grammar." },
  { name: "debug", tier: "tooling", version: "0.3.0", npm: true, go: true,
    blurb: "Inspect a live grammar — describe it, render it back as ABNF." },
  { name: "railroad", tier: "tooling", version: "0.3.0", npm: true, go: true,
    blurb: "Render railroad (syntax) diagrams from a grammar." },

  // Languages and data formats.
  { name: "json", tier: "grammar", version: "0.5.0", npm: true, go: true,
    blurb: "Standard JSON." },
  { name: "jsonc", tier: "grammar", version: "0.5.0", npm: true, go: true,
    blurb: "JSON with comments." },
  { name: "json5", tier: "grammar", version: "0.5.0", npm: true, go: true,
    blurb: "The JSON5 dialect." },
  { name: "jsonic", tier: "grammar", version: "0.5.0", npm: true, go: true,
    blurb: "A dynamic JSON parser that isn't strict and can be customised." },
  { name: "yaml", tier: "grammar", version: "0.5.0", npm: true, go: true,
    blurb: "YAML." },
  { name: "toml", tier: "grammar", version: "0.5.0", npm: true, go: true,
    blurb: "TOML." },
  { name: "ini", tier: "grammar", version: "0.5.0", npm: true, go: true,
    blurb: "INI files." },
  { name: "csv", tier: "grammar", version: "0.5.0", npm: true, go: true,
    blurb: "Delimited records — CSV, TSV, RFC 4180 quoting — into objects or arrays." },
  { name: "xml", tier: "grammar", version: "0.7.0", npm: true, go: true,
    blurb: "XML." },
