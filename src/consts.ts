...
export const PACKAGES: {
  ...
  { name: "support", tier: "tooling", version: "0.3.5", npm: true, go: true,
  ...
  { name: "json", tier: "grammar", version: "0.5.10", npm: true, go: true,
    blurb: "Standard JSON." },
  { name: "jsonc", tier: "grammar", version: "0.5.7", npm: true, go: true,
  ...
  { name: "toml", tier: "grammar", version: "0.5.8", npm: true, go: true,
    blurb: "TOML." },
  { name: "ini", tier: "grammar", version: "0.5.9", npm: true, go: true,
    blurb: "INI files." },
  { name: "csv", tier: "grammar", version: "0.5.9", npm: true, go: true,
    blurb: "Delimited records (CSV, TSV, RFC 4180 quoting) into objects or arrays." },
  { name: "xml", tier: "grammar", version: "0.7.8", npm: true, go: true,
    blurb: "XML." },
  ...
  { name: "markdown", tier: "grammar", version: "0.7.5", npm: true, go: true,
    blurb: "Markdown: the full CommonMark spec, 652/652 on the reference suite." },
  { name: "css", tier: "grammar", version: "0.5.8", npm: true, go: true,
